...
<body class="body">
    <?php require 'cabecera.php';
            ...
            $consulta = "UPDATE rurales SET nombre='$Nombre', ubicacion='$Ubicacion', precio='$Precio', metros='$Metros', habitaciones='$Habitaciones', pisos='$Pisos', baños='$Baños', garage='$Garage', imagen='$Imagen' WHERE id='".$id."';";
            ...
            if (!$resul){
                ...
                header("Location: GestRurales.php");
            };
