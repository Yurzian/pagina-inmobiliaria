...
<body class="body">
    <?php require 'cabecera.php';
            ...
            $consulta = "UPDATE viviendas SET nombre='$Nombre', tipo='$Tipo', ubicacion='$Ubicacion', precio='$Precio', metros='$Metros', habitaciones='$Habitaciones', pisos='$Pisos', baños='$Baños', garage='$Garage', imagen='$Imagen' WHERE id='".$id."';";
